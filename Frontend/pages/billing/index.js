...
const Index = ({ isScriptLoaded, isScriptLoadSucceed }) => {
  ...
  const processPayment = async () => {
    const session = await axios.post(
        'https://madewell-backend.herokuapp.com/payment/session-initiate',
        {
          ...
          lineItem: {
            ...
            images: ['https://madewell-backend.herokuapp.com/images/products/1.png'],
            amount: 100,
            currency: 'eur',
            quantity: 1,
          },
          successUrl: 'https://madewell.herokuapp.com/',
          cancelUrl: 'https://madewell.herokuapp.com/error',
        }
    );
  }

  return (
    <Container className={"mb-5"} style={{ marginTop: 60 }}>
      <Head>
        <title>Billing</title>
